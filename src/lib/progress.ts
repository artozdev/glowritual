...
const PHRASE: Record<CriterionId, string> = {
  ...
  glow: "d'éclat",
  imperfections: 'sur les imperfections',
  post_acne_marks: 'sur les marques',
  skin_texture: 'de texture',
  pigmentation: 'de teint',
  wrinkles: 'sur les ridules',
  firmness: 'de fermeté',
  dark_circles: 'sur les cernes',
  shine: 'sur la zone T',
  lip_brow_care: 'de soin',
  neck: 'sur le cou',
  hair_scalp: 'sur les cheveux',
  symmetry: "d'harmonie",
  posture: 'de posture',
  tone: 'de tonus',
